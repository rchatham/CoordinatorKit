...
1. Confirm the build is [passing in travis](https://travis-ci.org/nathanlanza/CoordinatorKit)
...
2. Push a release commit
   ...
   2. Rename the old Master section like:
          ## [1.0.5](https://github.com/nathanlanza/CoordinatorKit/releases/tag/1.0.5)
...
4. Create Carthage binaries
   ...
   2. `carthage archive CoordinatorKit`
